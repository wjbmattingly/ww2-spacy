...
| **Version** | `0.0.7` |
| **spaCy** | `>=3.4.4,<3.5.0` |
| **Default Pipeline** | `sentencizer`, `span_ruler`, `military_personnel`, `find_ghetto`, `clean_spans`, `clean_tank` |
| **Components** | `sentencizer`, `span_ruler`, `military_personnel`, `find_ghetto`, `clean_spans`, `clean_tank` |
